...
activity_mappings = (
    {
        "__doc__": """
    This dictionary provides a structured mapping of activities ('fuel_combustion', 'energy_consumption') that generate greenhouse gas emissions.
    Each activity is further classified by specific subcategories, which detail factors like fuel types, end-user categories, and usage contexts.
    ...
    """,
        ...
        "fuel_combustion": {
            ...
            "gpc_refno": [  # maybe also a description field here to explain the GPC reference numbers and what the meaning is here (e.g. we use it as a prefilter here right?)
                # So maybe: "The activity of fuel combustion is applied for the GPC reference numbers listed in this field. These numbers are used as a prefilter to identify the activity in the dataset."
                "I.1.1",
                "I.2.1",
                "I.3.1",
                "I.4.1",
