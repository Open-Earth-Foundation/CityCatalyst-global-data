...
def extract_scope_agent_step_2(
    ...
    input_path_csv = get_run_path(state, "step_2/steps/5_sub_sector.csv")
    input_path_script = get_run_path(state, "step_2/steps/5_sub_sector.py")
    ...
    output_path_csv = get_run_path(state, "step_2/steps/6_scope.csv")
    output_path_script = get_run_path(state, "step_2/steps/6_scope.py")
    output_path_markdown = get_run_path(state, "step_2/steps/6_scope.md")
...
d. Identify columns in the dataframe 'df' that help to determine the GPC scope. Especially look for columns that contain information about the type of activity like fuel combustion or energy conumption.
