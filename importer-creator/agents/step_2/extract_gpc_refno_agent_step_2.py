...
def extract_gpc_refno_agent_step_2(
    ...
    input_path_csv = get_run_path(state, "step_2/steps/6_scope.csv")
    input_path_script = get_run_path(state, "step_2/steps/6_scope.py")
    ...
    output_path_csv = get_run_path(state, "step_2/steps/7_gpc_refno.csv")
    output_path_script = get_run_path(state, "step_2/steps/7_gpc_refno.py")
    output_path_markdown = get_run_path(state, "step_2/steps/7_gpc_refno.md")
