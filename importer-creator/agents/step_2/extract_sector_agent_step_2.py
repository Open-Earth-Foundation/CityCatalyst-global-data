...
def extract_sector_agent_step_2(
    ...
    input_path_csv = get_run_path(state, "step_2/steps/3_actor_name.csv")
    input_path_script = get_run_path(state, "step_2/steps/3_actor_name.py")
    ...
    output_path_csv = get_run_path(state, "step_2/steps/4_sector.csv")
    output_path_script = get_run_path(state, "step_2/steps/4_sector.py")
    output_path_markdown = get_run_path(state, "step_2/steps/4_sector.md")
