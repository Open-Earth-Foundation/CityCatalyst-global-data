...
def extract_activity_name_agent_step_3(
    ...
    # Only on the GPC reference number is enough?
    """
    This agent extracts the GPC 'activity_name' based on the GPC reference number of the dataframe 'df'.
    ...
    input_path_csv = get_run_path(state, "step_2/final/final_output.csv")
    input_path_script = get_run_path(state, "step_2/final/final_output.py")
    ...
    output_path_csv = get_run_path(state, "step_3/steps/1_activity_name.csv")
    output_path_script = get_run_path(state, "step_3/steps/1_activity_name.py")
    output_path_markdown = get_run_path(state, "step_3/steps/1_activity_name.md")
...
- additional context for identifying activities in <mappings_activities> tags. 
"""
