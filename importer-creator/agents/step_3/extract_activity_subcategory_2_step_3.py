...
e. Determine the GPC 'activity_subcategory_type2' based on the content of the dataframe 'df', the user provided context in <user_context> tags and the additional context provided within <context_activities> tags. 
- Each row in the dataframe 'df' should be assigned a GPC 'activity_subcategory_type2' based on the provided context. 
- To do this you need to inspect the dataframe 'df' row by row and assign each row a  GPC 'activity_subcategory_type2' based on the information provided in this row.
f. Identify columns in the dataframe 'df' that help to determine the GPC 'activity_subcategory_typename2' based on the content of the dataframe 'df', the user provided context in <user_context> tags and the additional context provided within <context_activities> tags. 
- Print out the unique values of these identified columns to make sure to include every unique value in your answer.
- Each row in the dataframe 'df' should be assigned a GPC 'activity_subcategory_typename2' based on the provided context. 
- To do this you need to inspect the dataframe 'df' row by row and assign each row a GPC 'activity_subcategory_typename2' based on the information provided in that row.
