...
e. Determine the GPC 'activity_subcategory_type2' based on the content of the dataframe 'df', the user provided context in <user_context> tags and the additional context provided within <mappings_activities> tags. 
...
f. Identify columns in the dataframe 'df' that help to determine the GPC 'activity_subcategory_typename2' based on the content of the dataframe 'df', the user provided context in <user_context> tags and the additional context provided within <mappings_activities> tags. 
...
g. Create a python script based on the script provided within <prior_script> tags. This python script must contain the following:
    ...
    2. a mapping dictionary for the GPC 'activity_subcategory_type2' based on your prior analysis in step 'e'.
