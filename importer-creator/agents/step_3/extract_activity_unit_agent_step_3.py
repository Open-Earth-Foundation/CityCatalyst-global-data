...
c. Determine the GPC 'activity unit' based on the content of the dataframe 'df'. Each row in the dataframe 'df' should be assigned a GPC 'activity unit' based on the provided context. 
