"""cl-minvu/cl-minvu-fondos: read this source's own raw_data file from S3, tag it, hand to the merge block.
...
SOURCE = "cl-minvu/cl-minvu-fondos"

@data_loader
def load_data(*args, **kwargs):
    bucket = kwargs.get("source_bucket", "test-global-api")
    version = kwargs.get("source_release_version", "v1")
    key = f"raw_data/cl_minvu/cl_minvu_fondos/release/{version}/cl_minvu_fondos.csv"
