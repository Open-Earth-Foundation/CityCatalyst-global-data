"""cl-corfo/cl-corfo-finance: read this source's own raw_data file from S3, tag it, hand to the merge block.
...
SOURCE = "cl-corfo/cl-corfo-finance"

@data_loader
def load_data(*args, **kwargs):
    bucket = kwargs.get("source_bucket", "test-global-api")
    version = kwargs.get("source_release_version", "v1")
    key = f"raw_data/cl_corfo/cl_corfo_finance/release/{version}/cl_corfo_finance.csv"
