...
def load_from_s3_bucket(*args, **kwargs):
    ...
    object_key_co2 = 'files/climatetrace/version_2025/AR/CO2/manufacturing/*_emissions_sources_v*.csv'
    object_key_ch4 = 'files/climatetrace/version_2025/AR/CH4/manufacturing/*_emissions_sources_v*.csv'
    object_key_n2o = 'files/climatetrace/version_2025/AR/N2O/manufacturing/*_emissions_sources_v*.csv'
