"""cl-subdere/cl-subdere-fondos: read this source's own raw_data file from S3, tag it, hand to the merge block.
...
SOURCE = "cl-subdere/cl-subdere-fondos"

@data_loader
def load_data(*args, **kwargs):
    bucket = kwargs.get("source_bucket", "test-global-api")
    version = kwargs.get("source_release_version", "v1")
    key = f"raw_data/cl_subdere/cl_subdere_fondos/release/{version}/cl_subdere_fondos.csv"
