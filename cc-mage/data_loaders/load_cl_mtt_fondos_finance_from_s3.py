"""cl-mtt/cl-mtt-fondos: read this source's own raw_data file from S3, tag it, hand to the merge block.
...
SOURCE = "cl-mtt/cl-mtt-fondos"

@data_loader
def load_data(*args, **kwargs):
    bucket = kwargs.get("source_bucket", "test-global-api")
    version = kwargs.get("source_release_version", "v1")
    key = f"raw_data/cl_mtt/cl_mtt_fondos/release/{version}/cl_mtt_fondos.csv"
