"""cl-subdere/cl-subdere-sinim (municipal fiscal & institutional capacity): bare S3 read.
Thin per-source ingestion block; shaping (autonomy/capacity/archetype, locode) lives in
...
def load_data(*args, **kwargs):
    ...
    key = f"raw_data/cl_subdere/cl_subdere_sinim/release/{version}/cl_subdere_sinim.csv"
