"""cl-indap/cl-indap-fondos: read this source's own raw_data file from S3, tag it, hand to the merge block.
...
def load_data(*args, **kwargs):
    ...
    key = f"raw_data/cl_indap/cl_indap_fondos/release/{version}/cl_indap_fondos.csv"
