WITH raw_sv_index AS (
    SELECT 
        ...
        'areas of global conservation value' as indicator_name,
        areas_of_global_conservation_value::numeric as indicator_score,
        null as indicator_units,
        2024 as indicator_year, 
        'current' as scenario_name,
        'EarthEngine' as datasource
    FROM raw_data.ccra_icare_conservation_area a 
...
DROP TABLE raw_data.ccra_icare_conservation_area;