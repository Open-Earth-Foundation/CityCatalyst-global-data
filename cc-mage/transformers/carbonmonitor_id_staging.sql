DROP TABLE IF EXISTS raw_data.carbonmonitor_staging_v2025;

CREATE TABLE raw_data.carbonmonitor_staging_v2025 AS 
WITH staging_data AS (
SELECT *
FROM raw_data.carbonmonitor_staging
),
staging_activity AS (
SELECT 	*,
		MD5(CONCAT_WS('-', activity_name, activity_units, activity_subcategory_type::TEXT, gpcmethod_id))::UUID AS activity_id,
