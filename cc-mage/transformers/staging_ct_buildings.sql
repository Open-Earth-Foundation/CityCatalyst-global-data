DROP TABLE IF EXISTS raw_data.ct_buildings_staging;

CREATE TABLE raw_data.ct_buildings_staging AS 
WITH data_raw AS (
SELECT 
  iso3_country,
  sector,
...
FROM data_raw a 
LEFT JOIN raw_data.ct_buildings_mapping b 
