WITH raw_index AS (
    SELECT 
        ...
        'water security index' as indicator_name,
        Water_Security_Index_num::numeric as indicator_score,
        'Index' as indicator_units,
        2021 as indicator_year, 
        'current' as scenario_name,
        'ANA' as datasource
    FROM raw_data.ccra_icare_water_security a
