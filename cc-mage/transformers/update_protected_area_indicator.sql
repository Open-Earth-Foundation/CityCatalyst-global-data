WITH raw_biodiversity_index AS (
    SELECT 
        ...
        'protected area' as indicator_name,
        percentual::numeric as indicator_score,
        'percent' as indicator_units,
        2024 as indicator_year, 
        'current' as scenario_name,
        'WDPA' as datasource
    FROM raw_data.ccra_icare_protected_area a
...
upsert_data AS (
    SELECT 
        ...
        indicator_score,
        a.indicator_units,
        indicator_score AS indicator_normalized_score,
        indicator_year,
        scenario_name,
        datasource    
    FROM 
