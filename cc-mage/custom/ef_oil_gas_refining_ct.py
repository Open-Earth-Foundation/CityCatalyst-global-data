...
def transform_custom(*args, **kwargs):
    ...
    # Filter df
    ef_df = ef_df[['source_id', 'actor_id', 'gas_name', 'emissionfactor_value', 'start_time', 'end_time', 'source_type', 'source_name', 'activity_name']]  #Note: actor_id here is the country id
