"""
Standardize action_pathway descriptions to remove geography-specific references.

This script updates three actions in modelled.action_pathway to have generic,
globally-applicable descriptions instead of Brazil-specific ones:
- icare_0002: Energy labeling programs (removed "Brazilian")
- ipcc_0039: Sustainable material substitution (removed Brazil bioeconomy specifics)
...
def standardize_action_pathway_descriptions() -> None:
    """Update action_pathway descriptions to be geographically neutral."""
    
    config_path = path.join(get_repo_path(), 'io_config.yaml')
    config_profile = 'default'
    
    # SQL to update all three actions
    update_queries = [
    ...
    with Postgres.with_config(ConfigFileLoader(config_path, config_profile)) as loader:
        for query in update_queries:
            ...
            print(f"Executed standardization query")


if __name__ == '__main__':
    standardize_action_pathway_descriptions()
